...
externalAdReply: {
        ...
        title: `✿ おさらぎ V3.0 - Yuraa ✿`,
        body: `Mau Script? Klik Gambar Ini :3`,
        thumbnailUrl: `https://files.catbox.moe/sle466.png`,
        sourceUrl: "-",
        mediaType: 1,
...
│ ∘  toolsmenu ( *Menu Alat* )
│
│ *BERI JEDA BOT 10 DETIK YA MANIESS*
╰──────────────━`
osaragi.sendMessage(m.chat, {
       image: { url: 'https://files.catbox.moe/333eh3.jpg'},
       caption: awal,
    contextInfo: {
      ...
      externalAdReply: {
        ...
        body: "✿ おさらぎ 2.0 - Yuraa ✿",
        thumbnailUrl: 'https://files.catbox.moe/sle466.png',
        sourceUrl: "https://whatsapp.com/channel/0029VawWaW38PgsEEn8s3b0U",
        mediaType: 1,
        renderLargerThumbnail: false
      }
    }
...
m.reply(`Berhasil mengubah autoread ke ${q}`)
        ...
        case 'getsession': {
            ...
            case 'script': {
            await sleep(1000)
let buy = `▧ 「 *SCRIPT YURAA I V3.0* 」
│
│ ∘  *Wait...*
│
│ ∘  *https://youtube.com/@waduhh1122*
│
╰──────────────━`
...
const url1 = `https://files.catbox.moe/333eh3.jpg`;
const url2 = `https://files.catbox.moe/333eh3.jpg`;
const url3 = `https://files.catbox.moe/333eh3.jpg`;
